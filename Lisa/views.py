...
def weather(text):
    try:
        ...
        return d
def movie(text):
    f = open(r"C:\Users\Prateek Singh\Downloads\New Folder\data\Complete_data.csv" , encoding='Utf-8')
    csv_f = csv.reader(f)
...
g = General(r'C:\python\project\mohit_project_python\project 1\lisa-data.xlsx')
